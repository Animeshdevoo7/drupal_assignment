...
class EditEmployee extends FormBase
{
    ...
    public function submitForm(array &$form, FormStateInterface $form_state)
    {
        ...
        unset($postData['update'], $postData['form_build_id'], $postData['form_token'], $postData['form_id']);
        ...
        $this->messenger()->addMessage($this->t('Data Updated  Successfully'), 'status',TRUE);
